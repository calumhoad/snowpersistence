# Repository for the manuscript: *Snow persistence lowers and delays peak NDVI, the vegetation index that underpins Arctic greening analyses*

## Content:
This repository contains the code and data necessary to replicate statistical data analyses, figures and tables in:

Hoad, C. G., Myers-Smith, I. H., Kerby, J. T., Colesie, C. and Assmann, J. J. (in press) *Snow persistence lowers and delays peak NDVI, the vegetation index that underpins Arctic greening analyses*
