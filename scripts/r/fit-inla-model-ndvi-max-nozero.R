...
# Remove 0 snow.auc values from data
s2.bl <- s2.bl %>% filter(snow.auc > 0)
s2.kl <- s2.kl %>% filter(snow.auc > 0)
s2.kh <- s2.kh %>% filter(snow.auc > 0)
s30.bl <- s30.bl %>% filter(snow.auc > 0)
